// lib/features/practice/presentation/view/harmonic_perception_exercise_screen.dart
...
class HarmonicPerceptionExerciseScreen extends StatefulWidget {
  final HarmonicExercise exercise;

  const HarmonicPerceptionExerciseScreen({super.key, required this.exercise});

  @override
  State<HarmonicPerceptionExerciseScreen> createState() =>
      _HarmonicPerceptionExerciseScreenState();
}

class _HarmonicPerceptionExerciseScreenState
    extends State<HarmonicPerceptionExerciseScreen> {
  ...
  void _playChord() {
    ...
    final midiNotes = widget.exercise.chordNotes
    ...
    return Column(
      children: [
        IconButton(
          ...
          iconSize: 100,
          onPressed:
              _instrumentSoundfontId != null && !_isPlaying ? onPressed : null,
        ),
